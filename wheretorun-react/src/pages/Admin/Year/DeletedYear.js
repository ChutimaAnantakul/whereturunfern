...
//lodergrapghl
const deletedYearMutations = loader(
  "../../../graphql/mutations/deletedYear.gql"
);

const yearIDQueries = loader("../../../graphql/queries/yearID.gql");

const DeletedYear = ({ match, history }) => {
  ...
  const [deletedYear] = useMutation(deletedYearMutations);
  const idRef = useRef();
  ...
  const { error, loading, data } = useQuery(yearIDQueries, {
    variables: {
      id,
    },
              ...
              >
                <form>
                  ...
                  <Box p={2}>
                    ...
                    <h6>You want to delete this yaer !!</h6> <br />
