...
function EditEventORG({ match, history }) {
  ...
  console.log("ยังไม่อนุมัติ สถานะ=false, อนุมัติแล้ว สถานะ=true")
  console.log("สถานะ=",disa);
                          ...
                          <ListItem>
                            ...
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                              <div className="form col-md-11">
                                ...
                                onChange={() =>
                                  setlongitude(openforapplicationsRef.current.value)
                                }
                                disabled
                                fullWidth
                              />
                              <p>สุดท้าย</p>
                               <input
                                ...
                                onChange={() =>
                                  setlongitude(applicationdeadlineRef.current.value)
                                }
                                disabled
                                fullWidth
                              />
                          ...
                          <ListItem>
                            ...
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                              <div className="form col-md-11">
                                ...
                                ref={startdateRef}
                                onChange={() =>
                                  setlongitude(startdateRef.current.value)
                                }
                                disabled
                                fullWidth
                              />
                              <p>สุดท้าย</p>
                               <input
                                ...
                                ref={enddateRef}
                                onChange={() =>
                                  setlongitude(enddateRef.current.value)
                                }
                                disabled
                                fullWidth
                              />
