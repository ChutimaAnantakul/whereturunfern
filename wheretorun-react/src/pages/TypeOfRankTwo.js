...
function TypeOfRankTwo({ history, match }) {
  ...
  const handleSubmit = async (e) => {
    if (
      ...
      history.push(`/allranking/${data.createRanking.ranking.eventId}`);
    }
  };
                            ...
                            <ListItem>
                              ...
                              <div className="form col-md-5 ">
                                ...
                                <select
                                  ...
                                  required
                                >
                                  <option key={data.typeofranks.nodes[1].id} value={data.typeofranks.nodes[1].id}>
                                    {data.typeofranks.nodes[1].ranknameTh}
                                  </option>
